...
An automated, state-aware cart recovery engine built in Make.com featuring Supabase database logging, dynamic delay handling, and Gemini AI personalization.
...
> 📹 **[Watch the 3-Minute Architecture & Live Execution Walkthrough on Loom](https://www.loom.com/share/311bfc94eee1429080f6fe5ed3cf62c0)**
...
5. **Text Parsing & Custom Gmail Dispatch:** Leverages standard `Text Parser` to extract generated email bodies and subjects, then fires recovery emails via `Custom Gmail`.
